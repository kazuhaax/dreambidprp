          ...
          <div className="card p-8 space-y-8">
            ...
            <div className="text-center space-y-3">
              ...
              <div className="flex justify-center">
                <div className="w-16 h-16 bg-gold rounded-btn flex items-center justify-center shadow-dark-elevation">
                  <svg className="w-8 h-8 text-midnight-950" fill="none" stroke="currentColor" viewBox="0 0 24 24">
